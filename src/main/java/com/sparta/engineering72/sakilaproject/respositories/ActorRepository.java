...
//        public List<Integer> getFilmsByActor(Integer actorId){
//        List<FilmActor> filmActorList = getAllFilmActors();
//        List<Integer> filmsByActor = new ArrayList<>();
//        for(FilmActor filmActor : filmActorList){
//            if(filmActor.getActorId() == actorId) filmsByActor.add(filmActor.getFilmId());
//        }
//        return filmsByActor;
//    }
}
