...
public class FilmActorPK implements Serializable {
	...
	@Column(name="actor_id", nullable=false, unique=true, updatable=false, insertable=false)
	private int actorId;

	@Column(name="film_id", nullable=false, unique=true, updatable=false, insertable=false)
	private int filmId;
